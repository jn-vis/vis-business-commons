...
public class VisEntityGroupResumesPerceptionsByRecruiter{

	public static final CcpEntity ENTITY = CcpFactoryEntity.getEntityInstance(VisEntityGroupResumesPerceptionsByRecruiter.class);
