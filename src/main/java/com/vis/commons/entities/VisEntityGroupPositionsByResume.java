...
public class VisEntityGroupPositionsByResume {
	
	public static final CcpEntity ENTITY = CcpFactoryEntity.getEntityInstance(VisEntityGroupPositionsByResume.class);
