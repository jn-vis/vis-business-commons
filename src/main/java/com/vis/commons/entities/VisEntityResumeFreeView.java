...
@CcpEntitySpecifications(
	    ...
	    save = @CcpEntityOperationSpecification(afterOperation = {}, beforeOperation = {JnJsonTransformerPutEmailHash.class, VisJsonTransformerPutEmailHashAndDomainRecruiter.class}, classWithFieldsValidationsRules = CcpIgnoreFieldsValidation.class),
