...
public class VisEntityGroupResumesPerceptionsByResume{
	
	public static final CcpEntity ENTITY = CcpFactoryEntity.getEntityInstance(VisEntityGroupResumesPerceptionsByResume.class);
